...
Acquire the cryptoRandomID module for random ID Generator.
*/

const EC = require('elliptic').ec;
const cryptoHash = require('./crypto-hash');
const cryptoRandomID = require('./crypto-randomID')
...
module.exports = { ec, verifySignature, cryptoHash, cryptoRandomID };